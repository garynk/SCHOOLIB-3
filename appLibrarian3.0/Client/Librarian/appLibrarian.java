...
public class appLibrarian extends javax.swing.JFrame {
    ...
    private static boolean strongPassword = false;
    ...
    private void initComponents() {
        ...
        HardCheckbox = new javax.swing.JCheckBox();
        ...
        newUserDialog.setPreferredSize(new java.awt.Dimension(858, 570));
        newUserDialog.setSize(new java.awt.Dimension(858, 570));

        newUserPanel1.setBackground(LibrarianStyle.BACKGROUD_DEFAULT_1);
        newUserPanel1.setPreferredSize(new java.awt.Dimension(868, 532));
        ...
        InquadramentiComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(UtenteReader.INQUADRAMENTI_READER_DEFAULT));
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(InquadramentiComboBox, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(newuserErrorInquadLabel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(ClasseSezioneField, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(32, 32, 32))
        );
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(InquadramentiComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        HardCheckbox.setText("Password Hard");
        ...
        newUserPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(newUserPanel1Layout.createSequentialGroup()
                ...
                .addGap(191, 191, 191))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, newUserPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(newUserPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        newUserDialogLayout.setHorizontalGroup(
            ...
            .addGroup(newUserDialogLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(newUserPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 839, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void normalizejTable(javax.swing.JTable generic_table,
        ...
        Vector<Vector> all_elem = new Vector<>();
    ...
    private boolean checkAllnewUserField() throws RemoteException {
      ...
      if (need_classe_sezione){
        controller = local_librarian.checker.userChecker.checkInquadramentoClasse(ClasseSezioneField.getText());  
      }
      else controller = 0;
        ...
        if (controller != 0) { 
            ...
            if (controller == 2) {
                refreshGenericLabel(newuserErrorInquadLabel, newuserErrorInquadLabel.getForeground(), "Deve essere: <num><lettera>");
            }

        } else {
            ClasseSezioneField.setBorder(LibrarianStyle.DEFAULT_MATTE_REGISTRATION);
            newuserErrorInquadLabel.setVisible(false);
            correct++;
        }
    ...
    private void DeleteAccButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteAccButtonActionPerformed
        ...
        if (result == AskinDeletingOptionPane.YES_OPTION) {
            ...
            local_librarian.deleteUserAccount(local_librarian.getUser().getUserID(), local_librarian.getDefaultType());
            AskinDeletingOptionPane.setVisible(false);
            ModifyDialog.setVisible(false);
            this.setVisible(false);
    ...
    private void riconsegnaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_riconsegnaButtonActionPerformed
        ...
        if (local_librarian.checker.userChecker.checkCodiceFiscale(prestitoTextField.getText()) != 0) {
            ...
            if (local_librarian.checkExistingEasyPrenPres(selected_ISBN, prestitoTextField.getText(), 5)) {
                ...
                local_librarian.deletePrestitoPrenotazioneByISBNByID(Integer.parseInt(selected_ISBN.trim()), prestitoTextField.getText().trim(), 5);
                ...
                if (local_librarian.countPrenotazioniPrestitiByID(prestitoTextField.getText(), 5) < local_librarian.getMaxPrenotazioni())
                {
                    ...
                    if (local_librarian.getUserIDFromPrenPrestByISBN(selected_ISBN, 4).size() > 0)
                    {
                        if (local_librarian.getUserIDFromPrenPrestByISBN(selected_ISBN, 4).contains(prestitoTextField.getText()))
                        {
                            ...
                            local_librarian.deletePrestitoPrenotazioneByISBNByID(Integer.parseInt(selected_ISBN.trim()), prestitoTextField.getText().trim(), 4);
    ...
    private void disdiciPrenotazionerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_disdiciPrenotazionerButtonActionPerformed
        ...
        else if (local_librarian.checkParametricExisting("USERID", creanuovaPrenotazioneTextField.getText(), 2))
        {
            ...
            local_librarian.deletePrestitoPrenotazioneByISBNByID(Integer.parseInt(selected_ISBN.trim()), creanuovaPrenotazioneTextField.getText(), 4);
    ...
    private void deleteUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteUserButtonActionPerformed
        ...
        if (local_librarian.checker.userChecker.checkCodiceFiscale(deleteUserTextField.getText()) != 0) {
            ...
            local_librarian.deleteUserAccount(deleteUserTextField.getText(), 2);
        ...
        try {
            if (checkAllnewUserField()) {
                try {
                    ...
                    String inquadr;
                    if (need_classe_sezione) inquadr = InquadramentiComboBox.getSelectedItem() + "-" + ClasseSezioneField.getText();
                    else inquadr = InquadramentiComboBox.getSelectedItem().toString();
                   ...
                   char[] pass;
                    if (HardCheckbox.isSelected()){
                        pass = local_librarian.generateStrongPassword();
                    }
                   
                    else{
                     pass = local_librarian.generatePassword();   }
                    
                    char[] newusercode = local_librarian.generateUserCode(newUserCodiceTxtField.getText());
                    
                    Utente generico = new UtenteReader(nome, cognome, code, email, inquadr, tel, pass, newusercode );
                   ...
                   // ROBAxxx
                    ...
                    refreshGenericLabel(newuserSuccessLabel, LibrarianStyle.SUCCESS_COLOR, "Utente reader creato!");
                    Thread.sleep(1250);
                   ...
                   refreshGenericLabel(newuserSuccessLabel, LibrarianStyle.EXCEPTION_COLOR, "Errore sui campi");
            }
        } catch (RemoteException ex) {
            Logger.getLogger(appLibrarian.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static boolean passIsStrong(){
        return strongPassword;
    }
    public static void setPassStrong(){
        strongPassword = true;
    }
    public static void setPassStandard(){
    ...
    private javax.swing.JCheckBox HardCheckbox;
