 ...
 */
public class appLibrarianRegistrationForm extends javax.swing.JFrame {

    /**
     * Creates new form appLibrarianRegistrationForm
     */
    ...
    private void initComponents() {
        ...
        setBackground(LibrarianStyle.BACKGROUD_DEFAULT_1);
        setResizable(false);
        ...
        nomeLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        nomeLabel.setText("Nome: ");

        NomeTextField.setBackground(Layer2.getBackground());
        ...
        cognomeLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        cognomeLabel.setText("Cognome: ");

        CognomeTextField.setBackground(Layer2.getBackground());
        ...
        emailLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        emailLabel.setText("Email: ");

        EmailTextField.setBackground(Layer2.getBackground());
        ...
        codicefiscaleLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        codicefiscaleLabel.setText("Codice fiscale: ");

        CodicefiscaleTextField.setBackground(Layer2.getBackground());
        ...
        telephoneLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        telephoneLabel.setText("Numero di Telefono: ");

        TelephoneTextField.setBackground(Layer2.getBackground());
        ...
        pswLabel.setFont(LibrarianStyle.LABEL_FONT_2);
        pswLabel.setText("Password: ");

        PasswordField.setBackground(Layer2.getBackground());
        ...
        ErrorNomeLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorNomeLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        ErrorCognomeLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorCognomeLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        ErrorCodiceFiscaleLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorCodiceFiscaleLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        ErrorEmailLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorEmailLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        ErrorNumTelLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorNumTelLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        ErrorPswLabel.setFont(LibrarianStyle.EXCEPTION_FONT);
        ErrorPswLabel.setForeground(LibrarianStyle.EXCEPTION_COLOR);
        ...
        SuccessLabel.setFont(LibrarianStyle.SUCCESS_LABEL_FONT);
        SuccessLabel.setForeground(LibrarianStyle.SUCCESS_COLOR);
                            ...
                            .addGroup(Layer2Layout.createSequentialGroup()
                                .addGroup(Layer2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(Layer2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(CognomeTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 170, Short.MAX_VALUE))
        ...
        RegistrationH1.setText("Librarian Registration");
    ...
    private boolean CheckAllField() throws RemoteException {
        ...
        controller = librarian.checker.userChecker.checkAvaliableNomeCognome(NomeTextField.getText());
        ...
        controller = librarian.checker.userChecker.checkAvaliableNomeCognome(CognomeTextField.getText());
        if (controller != 0) {
        ...
        controller = librarian.checker.userChecker.checkCodiceFiscale(CodicefiscaleTextField.getText());
        if (controller != 0) {
        ...
        controller = librarian.checker.userChecker.checkEmail(EmailTextField.getText());
        if (controller != 0) {
        ...
        controller = librarian.checker.userChecker.checkNumero(TelephoneTextField.getText());
        if (controller != 0) {
            ...
            TelephoneTextField.setBorder(LibrarianStyle.DEFAULT_MATTE_REGISTRATION);
            ErrorNumTelLabel.setVisible(false);
            correct++;
        }

        controller = librarian.checker.userChecker.checkPassword(PasswordField.getPassword());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(appLibrarianRegistrationForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
