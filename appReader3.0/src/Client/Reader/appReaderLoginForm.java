...
public class appReaderLoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ConfirmationCodeDialog.setBackground(ReaderStyle.BACKGROUD_DEFAULT_1);
        ConfirmationCodeDialog.setBounds(new java.awt.Rectangle(0, 0, 400, 250));
        ConfirmationCodeDialog.setFocusable(false);
        ConfirmationCodeDialog.setFont(ReaderStyle.LABEL_FONT_2);
        ...
        ConfirmDiagLayer1.setBackground(ReaderStyle.BACKGROUD_DEFAULT_1);
        ConfirmDiagLayer1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ConfirmDiagLayer1.setFont(ReaderStyle.LABEL_FONT_3);
        ...
        DiscorsiveConfirmLabel.setFont(ReaderStyle.DISCORSIVE_LABEL_FONT);
        ...
        ConfirmationCodeField.setFont(ReaderStyle.LABEL_FONT_3);
        ...
        OKConfirmationButton.setBackground(ReaderStyle.BUTTON_DEFAULT_COLOR);
        OKConfirmationButton.setFont(ReaderStyle.BUTTON_FONT);
        ...
        ConfirmationDiagErrorLabel.setFont(ReaderStyle.DISCORSIVE_LABEL_FONT);
        ...
        forgotInserIdLabel.setFont(ReaderStyle.LABEL_FONT_2);
        ...
        forgotpswUserTxtField.setFont(ReaderStyle.LABEL_FONT_2);
        ...
        forgotConfirmButton.setBackground(ReaderStyle.BUTTON_DEFAULT_COLOR);
        forgotConfirmButton.setFont(ReaderStyle.BUTTON_FONT);
        ...
        forgotAnnullaButton.setBackground(ReaderStyle.BUTTON_DEFAULT_COLOR);
        forgotAnnullaButton.setFont(ReaderStyle.BUTTON_FONT);
        ...
        ForgotPasswordDialogLayout.setVerticalGroup(
            ForgotPasswordDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(frgpswLayer1, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
        );
        ...
        Layer1.setFont(ReaderStyle.BIG_TITLE_FONT);
        ...
        LoginLibH1.setText("Reader Login");
        ...
        Layer2.setFont(ReaderStyle.LABEL_FONT);
        Layer2.setPreferredSize(new java.awt.Dimension(600, 290));

        LoginErrorLabel.setFont(ReaderStyle.EXCEPTION_FONT);
        LoginErrorLabel.setForeground(ReaderStyle.EXCEPTION_COLOR);
        ...
        passForgotLabel.setFont(ReaderStyle.DISCORSIVE_LABEL_FONT);
        ...
        PasswordTextField.setFont(new java.awt.Font("Delius", 0, 23)); // NOI18N
        ...
        passForgotLabel1.setFont(ReaderStyle.DISCORSIVE_LABEL_FONT);
        ...
        RegistrationButton.setBackground(ReaderStyle.BUTTON_DEFAULT_COLOR);
        ...
        JoinInButton.setBackground(ReaderStyle.BUTTON_DEFAULT_COLOR);
        JoinInButton.setFont(ReaderStyle.BUTTON_FONT);
...
public static void initFont() {
    ...
    private void setConfirmDialogCloseSafe() {
        ConfirmationCodeDialog.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
                ...
                ConfirmationCodeDialog.getParent().setVisible(true);
            }
        });
    }
    ...
    private void setForgotPsWDialogCloseSafe() {
        ForgotPasswordDialog.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
                ...
                ForgotPasswordDialog.getParent().setVisible(true);
    ...
    private void RegistrationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrationButtonActionPerformed
        ...
        appReaderRegistrationForm registrationForm = new appReaderRegistrationForm(reader);
        ...
        try {
            ...
            if (checkField()) {
                ...
                if (confirmed_tmp_acc == 0) {
                    ...
                    if (reader.verifySessionUser(reader.getID())) {
                        ...
                        updateLabel(LoginErrorLabel, ReaderStyle.EXCEPTION_COLOR, "Utente già collegato");
                    }
                }
    ...
    private void OKConfirmationButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKConfirmationButtonActionPerformed
        ...
        if (reader.checker.userChecker.checkCodice(ConfirmationCodeField.getText()) != 0) {
            ...
            if (real_account_code.equals(ConfirmationCodeField.getText())) {
                ...
                if (attempts == 0) {
                    reader.deleteUserAccount(reader.getID(), reader.getType());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(appReaderLoginForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
