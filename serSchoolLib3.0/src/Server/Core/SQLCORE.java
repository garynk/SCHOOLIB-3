...
public class SQLCORE extends Thread {
    ...
    public boolean deleteUserAccount(String user_id, int type) throws Exception {

        return Deleter.deleteUserAccount(user_id, type);
    }
    ...
    public boolean deletePrenotazioneByISBNByID(int isbn, String userid, int type) throws Exception {
